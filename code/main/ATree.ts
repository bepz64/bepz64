    ...
    private update(): void{
        ...
        switch(Saving.loadNumber("aTreeStep")){
            ...
            case 1:
                ...
                this.addEnigma(new EnigmaAnswerStrings(["yes"]), new CallbackCollection(this.nextStep.bind(this), this.reward1.bind(this)), "aTreeFirstQuestionEnigma", "aTreeFirstQuestionWrong");
            break;
